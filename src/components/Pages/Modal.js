...
const Modal = ({ show, onClose, events }) => {
  ...
  return (
    <div className="modal-overlay mod-cl" style={{position:"absolute",bottom:0,left:0,width:"100%",zIndex:'9999999'}} >
      <div className="modal-content" style={{height: '200px',
    overflow: 'scroll',
    padding: '16px',position:"relative"}}>
      {/* <a onClick={onClose}><i class="nav-icon fas fa fa fa-close"></i></a> */}
      <a onClick={onClose} className='btn-cal-close'>
        <i class="nav-icon fas fa fa fa-close"></i>
      </a>
        <h2>Event Details</h2>
